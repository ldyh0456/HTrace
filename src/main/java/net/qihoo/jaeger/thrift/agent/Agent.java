 ...
 * @generated
 */
package net.qihoo.jaeger.thrift.agent;
...
public class Agent {
    ...
    public interface Iface {
        ...
        public void emitZipkinBatch(java.util.List<ThriftSpan> spans) throws org.apache.thrift.TException;

        public void emitBatch(net.qihoo.jaeger.thrift.thriftjava.Batch batch) throws org.apache.thrift.TException;

    }

    public interface AsyncIface {

        public void emitZipkinBatch(java.util.List<ThriftSpan> spans, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

        public void emitBatch(net.qihoo.jaeger.thrift.thriftjava.Batch batch, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    }

    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        private static final Log LOG = LogFactory.getLog(Agent.class);
        public static int udpSenderNumber;
        ...
        public void send_emitZipkinBatch(java.util.List<ThriftSpan> spans) throws org.apache.thrift.TException {
        ...
        public void send_emitBatch(net.qihoo.jaeger.thrift.thriftjava.Batch batch) throws org.apache.thrift.TException {
            emitBatch_args args = new emitBatch_args();
            args.setBatch(batch);
            udpSenderNumber += batch.spans.size();
            LOG.info("Udp Sender Span Number : " + udpSenderNumber);
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public static class emitZipkinBatch_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
            private java.util.List<ThriftSpan> spans;

            public emitZipkinBatch_call(java.util.List<ThriftSpan> spans, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class emitZipkinBatch_args implements org.apache.thrift.TBase<emitZipkinBatch_args, emitZipkinBatch_args._Fields>, java.io.Serializable, Cloneable, Comparable<emitZipkinBatch_args> {
        ...
        public java.util.List<ThriftSpan> spans; // required
        ...
        public emitZipkinBatch_args(
                java.util.List<ThriftSpan> spans) {
            this();
            this.spans = spans;
        }
        ...
        public emitZipkinBatch_args(emitZipkinBatch_args other) {
            if (other.isSetSpans()) {
                java.util.List<ThriftSpan> __this__spans = new java.util.ArrayList<ThriftSpan>(other.spans.size());
        ...
        public void addToSpans(ThriftSpan elem) {
            if (this.spans == null) {
                this.spans = new java.util.ArrayList<ThriftSpan>();
            }
            this.spans.add(elem);
        }

        public java.util.List<ThriftSpan> getSpans() {
            return this.spans;
        }

        public emitZipkinBatch_args setSpans(java.util.List<ThriftSpan> spans) {
            this.spans = spans;
            return this;
        }
            ...
            switch (field) {
                case SPANS:
                    if (value == null) {
                        ...
                        setSpans((java.util.List<ThriftSpan>) value);
                    }
                    break;
                            ...
                            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                                {
                                    ...
                                    struct.spans = new java.util.ArrayList<ThriftSpan>(_list0.size);
                                    ThriftSpan _elem1;
                                    for (int _i2 = 0; _i2 < _list0.size; ++_i2) {
                                        _elem1 = new ThriftSpan();
                                        _elem1.read(iprot);
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, emitZipkinBatch_args struct) throws org.apache.thrift.TException {
                ...
                if (struct.spans != null) {
                    oprot.writeFieldBegin(SPANS_FIELD_DESC);
                    {
                        ...
                        for (ThriftSpan _iter3 : struct.spans) {
                            _iter3.write(oprot);
                        }
                        oprot.writeListEnd();
                    }
                ...
                if (struct.isSetSpans()) {
                    {
                        ...
                        for (ThriftSpan _iter4 : struct.spans) {
                            _iter4.write(oprot);
                        }
                    }
                }
                ...
                if (incoming.get(0)) {
                    {
                        ...
                        struct.spans = new java.util.ArrayList<ThriftSpan>(_list5.size);
                        ThriftSpan _elem6;
                        for (int _i7 = 0; _i7 < _list5.size; ++_i7) {
                            _elem6 = new ThriftSpan();
                            _elem6.read(iprot);
    ...
    public static class emitBatch_args implements org.apache.thrift.TBase<emitBatch_args, emitBatch_args._Fields>, java.io.Serializable, Cloneable, Comparable<emitBatch_args> {
        ...
        public net.qihoo.jaeger.thrift.thriftjava.Batch batch; // required
        ...
        static {
            ...
            tmpMap.put(_Fields.BATCH, new org.apache.thrift.meta_data.FieldMetaData("batch", org.apache.thrift.TFieldRequirementType.DEFAULT,
                    new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, net.qihoo.jaeger.thrift.thriftjava.Batch.class)));
            metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
        ...
        public emitBatch_args(
                net.qihoo.jaeger.thrift.thriftjava.Batch batch) {
            this();
            this.batch = batch;
        }
        ...
        public emitBatch_args(emitBatch_args other) {
            if (other.isSetBatch()) {
                this.batch = new net.qihoo.jaeger.thrift.thriftjava.Batch(other.batch);
            }
        }
        ...
        public net.qihoo.jaeger.thrift.thriftjava.Batch getBatch() {
            return this.batch;
        }

        public emitBatch_args setBatch(net.qihoo.jaeger.thrift.thriftjava.Batch batch) {
            this.batch = batch;
            return this;
        }
            ...
            switch (field) {
                case BATCH:
                    if (value == null) {
                        ...
                        setBatch((net.qihoo.jaeger.thrift.thriftjava.Batch) value);
                    }
                    break;
                    ...
                    switch (schemeField.id) {
                        case 1: // BATCH
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                                struct.batch = new net.qihoo.jaeger.thrift.thriftjava.Batch();
